...
import com.lzh.libnetwork.cache.CacheManager;
...
public abstract class Request<T, R extends Request> implements Cloneable{
    ...
    //先访问网络，成功缓存到本地
    public static final int NET_CHACHE = 4;
    private String cacheKey;
    protected Type mType;
    private Class mClaz;
    private int mCacheStrategy;

    @IntDef({CACHE_ONLY, CACHE_FIRST, NET_CHACHE, NET_ONLY})
    ...
    private ApiResponse<T> readCache() {
        ...
        result.body = (T)cache;
        Log.e("xxx", "result.body: "+ result.body + " key : "+ key);
        result.success = true;
        return result;
    }
